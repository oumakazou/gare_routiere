...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="relative h-[500px] flex items-center justify-center bg-blue-900 text-white overflow-hidden">
        <div class="absolute inset-0 z-0">
            <img src="{{ asset('images/im1.png') }}" class="w-full h-full object-cover opacity-40">
            <div class="absolute inset-0 bg-gradient-to-b from-blue-900/60 to-gray-50"></div>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div class="group bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-100">
                <div class="relative h-64 overflow-hidden">
                    ...
                    <div class="absolute top-4 right-4 bg-blue-600 text-white px-4 py-1 rounded-full font-bold">
                        Dès 500 DH
                    </div>
                </div>
                <div class="p-8">
                    ...
                    <a href="{{ route('reservations.create', 'Marrakech') }}" 
                       class="block text-center bg-gray-900 text-white py-3 rounded-xl font-bold hover:bg-blue-600 transition shadow-lg">
                        Réserver ma place
                    </a>
                </div>
            </div>
            ...
            <div class="group bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-100">
                ...
                <div class="p-8">
                    ...
                    <a href="{{ route('reservations.create', 'Fes') }}" 
                       class="block text-center bg-gray-900 text-white py-3 rounded-xl font-bold hover:bg-blue-600 transition shadow-lg">
                        Réserver ma place
                    </a>
                </div>
            ...
            <div class="group bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-100">
                ...
                <div class="p-8">
                    ...
                    <a href="{{ route('reservations.create', 'Tanger') }}" 
                       class="block text-center bg-gray-900 text-white py-3 rounded-xl font-bold hover:bg-blue-600 transition shadow-lg">
                        Réserver ma place
                    </a>
                </div>
    ...
    <div class="bg-blue-600 py-12">
        <div class="max-w-7xl mx-auto px-4 text-center text-white">
            ...
            <a href="{{ route('contact') }}" class="bg-white text-blue-600 px-10 py-3 rounded-full font-black uppercase hover:bg-gray-100 transition">
                Demander un devis
            </a>
        </div>
    </div>
