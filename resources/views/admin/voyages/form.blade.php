        ...
        <form action="{{ $voyage->id ? route('admin.voyages.update', $voyage) : route('admin.voyages.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid gap-4 lg:grid-cols-2">
                <div>
                    ...
                    <select name="ville_depart_id" class="w-full rounded-2xl border border-slate-300 px-4 py-3 focus:border-red-500 focus:ring-2 focus:ring-red-200" required>
                ...
                <div>
                    ...
                    <select name="ville_arrivee_id" class="w-full rounded-2xl border border-slate-300 px-4 py-3 focus:border-red-500 focus:ring-2 focus:ring-red-200" required>
                        <option value="">Sélectionnez</option>
                        @foreach($villes as $v)
            ...
            <div class="grid gap-4 lg:grid-cols-2">
                <div>
                    ...
                    <input type="date" name="date_depart" value="{{ old('date_depart', $voyage->date_depart?->format('Y-m-d')) }}" class="w-full rounded-2xl border border-slate-300 px-4 py-3 focus:border-red-500 focus:ring-2 focus:ring-red-200" required />
                    @error('date_depart')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <select name="autocar_id" class="w-full rounded-2xl border border-slate-300 px-4 py-3 focus:border-red-500 focus:ring-2 focus:ring-red-200" required>
                        <option value="">Sélectionnez</option>
            ...
            <div class="grid gap-4 lg:grid-cols-3">
                <div>
                    ...
                    <input type="time" name="heure_depart" value="{{ old('heure_depart', $voyage->heure_depart?->format('H:i')) }}" class="w-full rounded-2xl border border-slate-300 px-4 py-3 focus:border-red-500 focus:ring-2 focus:ring-red-200" required />
                    @error('heure_depart')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="time" name="heure_arrivee" value="{{ old('heure_arrivee', $voyage->heure_arrivee?->format('H:i')) }}" class="w-full rounded-2xl border border-slate-300 px-4 py-3 focus:border-red-500 focus:ring-2 focus:ring-red-200" required />
                    @error('heure_arrivee')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <select name="type_voyage_id" class="w-full rounded-2xl border border-slate-300 px-4 py-3 focus:border-red-500 focus:ring-2 focus:ring-red-200" required>
                        <option value="">Sélectionnez</option>
            ...
            <div class="grid gap-4 lg:grid-cols-2">
                <div>
                    ...
                    <input type="number" name="base_price" value="{{ old('base_price', $voyage->base_price) }}" step="0.01" min="0" class="w-full rounded-2xl border border-slate-300 px-4 py-3 focus:border-red-500 focus:ring-2 focus:ring-red-200" required />
                    @error('base_price')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="flex gap-3 pt-4 border-t">
                ...
                <button type="submit" class="rounded-2xl bg-red-600 px-6 py-3 text-white font-semibold hover:bg-red-700">{{ $voyage->id ? 'Mettre à jour' : 'Créer' }}</button>
            </div>
        </form>
    </div>
</div>
