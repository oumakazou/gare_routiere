...
<div class="space-y-6">
    ...
    <div class="rounded-3xl bg-white p-6 shadow-sm border border-slate-200 flex justify-between items-center">
        ...
        <a href="{{ route('admin.autocars.create') }}" class="rounded-2xl bg-red-600 px-6 py-3 text-white font-semibold hover:bg-red-700 transition">+ Nouvel autocar</a>
    </div>
    ...
    <div class="rounded-3xl bg-white shadow-sm border border-slate-200 overflow-hidden">
                        ...
                        @foreach($autocars as $autocar)
                            <tr class="hover:bg-slate-50 transition">
                                ...
                                <td class="px-6 py-4 flex gap-2">
                                    <a href="{{ route('admin.autocars.edit', $autocar) }}" class="text-red-600 hover:text-red-700 font-semibold">✎ Éditer</a>
        ...
        @else
            <div class="p-12 text-center">
                ...
                <a href="{{ route('admin.autocars.create') }}" class="mt-4 inline-flex text-red-600 font-semibold hover:text-red-700">+ Créer le premier →</a>
            </div>
        @endif
    </div>
</div>
