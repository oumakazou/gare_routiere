...
<div class="space-y-6">
    ...
    <div class="rounded-3xl bg-white p-6 shadow-sm border border-slate-200 flex justify-between items-center">
        ...
        <a href="{{ route('admin.options.create') }}" class="rounded-2xl bg-blue-600 px-6 py-3 text-white font-semibold hover:bg-blue-700">+ Nouvelle</a>
    </div>
                        ...
                        @foreach($options as $opt)
                            <tr class="hover:bg-slate-50">
                                ...
                                <td class="px-6 py-4 flex gap-2">
                                    <a href="{{ route('admin.options.edit', $opt) }}" class="text-blue-600 hover:text-blue-700 font-semibold">✎ Éditer</a>
